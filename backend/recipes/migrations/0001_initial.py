...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='tag',
            constraint=models.UniqueConstraint(fields=('name', 'color', 'slug'), name='unique_tag_fields', violation_error_message={'%(class)s': '`name`, `color`, `slug` не уникальны'}),
        ),
        migrations.AddField(
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('name', 'measurement_unit'), name='unique_ingredient_fields', violation_error_message={'%(class)s': '`name`, `color`, `slug` не уникальны'}),
        ),
        migrations.AddField(
